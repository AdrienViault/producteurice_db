...
# Define the expected tables and (optionally) expected minimum row counts.
EXPECTED_TABLES = {
    "animal_category": {"min_rows": 1},
    "crop_category": {"min_rows": 1},
    "product_category": {"min_rows": 1},
    "seller_category": {"min_rows": 1},
}
